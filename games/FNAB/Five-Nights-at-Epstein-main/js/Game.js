...
class Game {
    ...
    showTutorial(type = 'night1') {
        ...
        if (type === 'night2') {
            ...
            // Night 1 教程：EP
            tutorialContent.innerHTML = `
                <h2>DEFEND YOURSELF AGAINST BRADEN</h2>
                <p>
                    BRADEN ALWAYS STARTS AT CAM 11. USE THE CAMERA'S AUDIO LURE TO KEEP BRADEN FAR AWAY FROM YOU. 
                    MAKE SURE THE CAMERA YOU'RE PLAYING THE SOUND IN IS NEXT TO THE CAMERA WHERE BRADEN IS. 
                    ...
                    BRADEN DOES NOT ATTACK THROUGH THE VENTS SO DON'T BOTHER CLOSING THEM FOR THIS NIGHT.
                </p>
                <button id="tutorial-got-it">GOT IT</button>
            `;
            // 重新绑定按钮事件
